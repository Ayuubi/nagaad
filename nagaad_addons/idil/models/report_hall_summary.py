...
class Kitchen_ReportWizard(models.TransientModel):
    ...
    def send_pdf_report_by_email(self):
        ...
        mail_values = {
            ...
            'body_html': '<p>Dear User,</p><p>Please find attached the Hall Summary Report.</p>',
            'email_to': "khadar1889@gmail.com",
            'attachment_ids': [(4, attachment.id)],  # Attach the generated PDF
        }
